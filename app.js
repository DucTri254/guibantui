...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi bạn yêu của tui :>";
    let charArrTitle = textTitle.split('');
let text = "Giáng sinh vui vẻ nha m, t làm thiệp này để chúc m giáng sinh an lành cũng như sẽ càng ngày càng tươi cười hơn nè. Định nói với m vài lời sến súa lun trong này nhưng thôi t nghĩ để bức khác hợp lí hơn kkk."
